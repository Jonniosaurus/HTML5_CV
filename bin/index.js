var CV = { 
  "Details": {
    "Address":"5 Lumley Place, Burley\n        Leeds, LS4 2NL",
    "Email":"contact@jonnyedwards.net",
    "Mob": "07896943379"
  },    
  ...
  "Knowledge": [
    ...
    {"Type": "Frameworks/SDKs", "List": [".NET", "AngularJS", "Bootstrap", "JQuery", "MS CRM SDK", "Android"]},
    {"Type": "Protocols", "List": ["AJAX", "WSDL", "SOAP", "JSON", "LDAP", "XAML"]}
  ],
  
  "Experience":[
    {"Name":"Dynamic CRM 2011", 
      "Details":"Over the last 2 years I have worked extensively with all aspects of Dynamics CRM Development. " +
    ...
    {"Name":"Home Developments", 
      ...
      "<li> I am currently writing a video game in Canvas for HTML.  I have implemented my own framework drawing from my existing experience.  For a sample of the work in progress please click <a href=\"bin/TestGame_0.3/index.html\" target=\"_blank\" title=\"my video game\">here</a>.</li>" +
      "<li> A shell binary I called \"Nut\", that roughly immitates Windows'\"Sticky Notes\" in the BASH shell on Linux.</li>" +
      "<li> In the past I have written a number of MVC-based websites for university and for friends.  Click <a href=\"bin/jonnyedwards.netSample/index.html\" title=\"my web site sample\" target=\"_blank\">here</a> to see a sample from my forthcoming website." +
      "</ul>"}
  ],
